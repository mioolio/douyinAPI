...
>抖音2026年8月6日更新了相关API
>多数功能已经不可使用
>但是不要害怕，不要着急，我们已经完成了逆向仅用不到一个小时，所有功能全部通过
>我们更新的思路面对频繁的更新逆向解密混淆vm并不是一个良好的做法，且会浪费我为数不多的精力，后面将采用伪环境和浏览器的方法
>并有利于提高性能和初始化。
>新的代码将在8月7号到8月8号完成推送并逐渐实现更多功能，比如说自动进入直播间评论。已读未读的自定义 等17+功能
---
---
